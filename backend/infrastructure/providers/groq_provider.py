    ...
    def evaluate_consultation(self, case_context: str, rubric: str, history: str, student_judgment: str) -> Dict[str, Any]:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "Actúa como un Profesor Senior de Obstetricia y Ginecología.\n"
                       "Basado en el caso clínico original:\n"
                       "{context}\n\n"
                       "Rúbrica de evaluación:\n{rubric}\n\n"
                       "Analiza el historial de conversación (cómo el alumno interrogó a la paciente):\n"
                       "{history}\n\n"
                       "Y evalúa el juicio diagnóstico final del estudiante: '{diagnosis}'.\n\n"
