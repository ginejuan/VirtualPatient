    ...
    def evaluate_consultation(self, case_context: str, rubric: str, history: str, student_judgment: str) -> Dict[str, Any]:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "Actúa como un Profesor Senior de Obstetricia y Ginecología muy estricto.\n"
                       ...
                       "5. ESCALA DE NOTAS: La rúbrica adjunta evalúa sobre 100 puntos. Suma los puntos que el alumno ha conseguido. Luego, OBLIGATORIAMENTE divide el total entre 10 para obtener la 'nota_final' en una escala de 0 a 10.\n\n"
